...
function productImageRoute() {
  const productImageLink = document.querySelectorAll(
    ".product-image a .img2"
  );
      ...
      <li class="product-item glide__slide">
        ...
        <div class="product-info">
          ...
          <div class="product-prices">
            <strong class="new-price">${CURRENCY}${product.price.newPrice.toFixed(2)}</strong>
            <span class="old-price">${CURRENCY}${product.price.oldPrice.toFixed(2)}</span>
          </div>
